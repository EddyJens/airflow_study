...
dag = DAG(
    'email_test', 
    description='Nossa email_test DAG',
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    default_view='graph',
    tags=['processo', 'email', 'pipeline']
)
...
task5 = BashOperator(task_id="tsk5", bash_command="sleep 2", dag=dag, trigger_rule='none_failed')
task6 = BashOperator(task_id="tsk6", bash_command="sleep 2", dag=dag, trigger_rule='none_failed')

send_email = EmailOperator(
    task_id="send_email",
    to="e.j.r.zavala6@gmail.com",
